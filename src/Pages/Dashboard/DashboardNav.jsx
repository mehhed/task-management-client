...
const DashBoardNav = ({ open, setOpen, dropdown, setDropdown }) => {
  ...
  return (
    <div>
      <section className="sticky top-0 z-40 px-3 py-3  shadow dark:text-gray-100 dark:bg-gray-200 lg:px-5">
        <nav className="relative">
          <div className="flex items-center justify-between">
            <div>
              <button
                onClick={() => setOpen(!open)}
                className={`px-2 py-3 text-blue-500 bg-blue-200 rounded ${
            ...
            <div className="flex items-center">
              ...
              <div className={`relative text-left lg:inline-block `}>
                ...
                <div
                  ...
                  <div className="py-1">
                    <a className="flex px-4 py-2 text-sm text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
                      <CiSettings />
                      Account
                    </a>
                    <a
